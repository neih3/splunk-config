...
sudo -u $SPLUNK_USER $SPLUNK_DIR/bin/splunk start --accept-license --seed-passwd "$SPLUNK_PASSWORD"
...
sudo -u $SPLUNK_USER $SPLUNK_DIR/bin/splunk enable boot-start --user $SPLUNK_USER
